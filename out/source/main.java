...
class PaintEngine{
    ...
    private void DrawGameScore(){
        ...
        int size = PApplet.parseInt( gameSettings.playAreaOffsetY / 2 ) + 10;
    ...
    private void DrawCountDown(){
        ...
        if( this.countDown != 0 ){
            ...
            DrawText( 
                str( this.countDown ),
                PApplet.parseFloat( width / 2 ), PApplet.parseFloat( height / 2 ),
                PApplet.parseInt( this.countDownSize ),
    ...
    private void DrawGameOver(){
        ...
        if( this.drawGameOverText ){
            ...
            if( this.drawGameScore ){
                ...
                if( this.drawRestart ){
                    DrawText( "Press 'r' to restart with current settingss, or 'm' to return to the menu", x, height - 0.1f*y, PApplet.parseInt(this.scoreTextSize/3), color( 255, this.startOverAlpha ) );
                }
            }
        }
    }
